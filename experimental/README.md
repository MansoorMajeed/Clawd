...
No user vaults, sessions, todo files, or mode settings were deleted or moved. Native `/new` replaces the removed `clear` extension; native edit replaces the removed `multi-edit` override (without cross-file batches or Codex patches).
